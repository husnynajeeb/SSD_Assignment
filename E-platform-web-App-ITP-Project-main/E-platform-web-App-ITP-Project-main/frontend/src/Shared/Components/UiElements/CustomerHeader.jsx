            ...
            >
              <div className="flex items-center gap-4 hover:cursor-pointer">
                ...
                <svg
                  class={`hidden fill-current sm:block ${
                    isProfileDropdown && "transform rotate-180"
                  }`}
                  width="12"
                  height="8"
                  viewBox="0 0 12 8"
              ...
              {isProfileDropdown && (
                <>
                  <div
                    ref={dropdownRef}
                    className={`absolute z-40 right-0 mt-1 flex w-64 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dropdownProfile ${
                      isProfileDropdown ? "dropdownProfile-visible" : ""
                    }`}
                  >
                    <div className="text-xs font-bold px-4 uppercase block mb-0 p-2 whitespace-nowrap text-gray-400 text-center">
