...
const UpdateCredit = (props) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`http://localhost:5000/supplier/${props.id}`)
      .then((res) => {
        setFormData(
          {
            credit: {
  ...
  const submitHandler = async (event) => {
    setLoading(true);
    axios
      .put(`http://localhost:5000/supplier/updateCredit/${props.id}`, {
              ...
              <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                  ...
                  <Input
                    ...
                    errorText="Please Enter Credit amount."
